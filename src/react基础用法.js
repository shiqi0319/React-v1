...
// 在react中 需要把 key 添加给被 forEach 或者 map 或者 for 包裹的 元素
// key 需要唯一,一般为id 这里可以暂时用 index 
const arr = [];
...
const myDiv =
    <div id="myDiv" tiile="这是一个div">
        ...
        <p className="myEle">react中class 更名为className </p>
        <label htmlFor="myFor">react 中 label中的 for 是特殊的字符 更名为 htmlFor </label>
    </div>
